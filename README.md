...
Another thing to know is the probability to request mail content and get an IOException. These could be because sometimes, randomly, yopmail requests you to resolve a captcha. 
